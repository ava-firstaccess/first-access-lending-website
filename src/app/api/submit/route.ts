...
// Generated from GHL Custom Fields API - March 31, 2026
// GET /locations/:id/customFields?model=opportunity (271 fields)
const FORM_TO_GHL: Record<string, string> = {
  ...
  'Lead - Stated Credit Score': 'ONng5zFrN8SWAytTTbIq',
  'Lead - Self-Reported Credit Rating': 'XOzCZ5fZdKBLjg9UITSf',
  'Borrower - New Loan Amount (Desired)': 'z7SUo9vnJSdAXe8IGost',
  'Loan Terms - Cash Out Amount': 'yagxQiOYI4kRpkGxXwf1',
  'Loan Terms - HELOC Draw Term': 'hrvIe3fo4W7Dmhp28QYT',
  'Loan Terms - HELOC Total Term': 'aiFIn7JOsummPdIOoqnL',
  'Loan Terms - CES Term': 'Wz2eOLz5eX4XEVFsrlhN',
  ...
  'Borrower - Marital Status': 'u8DpcmbMCpbdJ3XVcosi',
  ...
  'Borrower - Previous Employer Name 2': 'Rz3znW98ObE7fXthJ75T',
  'Borrower - Previous Employer Position 2': 'FKrh38XMT4IBQJFPVACv',
  'Borrower - Years at Previous Employer 2': 'vmOXzGNm1aj7TzFJ3gZm',
  'Borrower - Months at Previous Employer 2': 'UNtol8XoN5maVZYZIuJC',
  ...
  'Borrower - Prior Street Address': '8mthgG6TEE3FWPJeMYfn',
  ...
  'Second Mortgage - Type': 'zAv0qSOuARHlBTes5wK7',
  ...
  'Dec - Co-Borrower Obligated Alimony/Support': '87ZDhfknExfSceyIrwOQ',
  'Dec - Co-Borrower Alimony/Support Amount': 'EQBNK6HAtiaUUxNwMxqP',
  ...
  'Subject Property - Unit Number': 'moMnZKgIarJA6r3WuPk3',
  ...
  'Other Properties - Address 1 HOA': 'pOodzjTZlu4pBc3XdCno',
  'Other Properties - 1 Taxes - Monthly': 'G32hHcU17DoCapXLcEFV',
  'Other Properties - 1 Insurance - Monthly': 'eSx2JsXef4nCxKEb3olL',
  'Other Properties - 1 HOA Amount': 'A2pkPXuCiiEISmG41Hw1',
  'Other Properties - Address 2': 'xjEkhdpAJTgsVWVLCkEq',
  'Other Properties - Address 2 Escrowed': 'ommoyF1gGi9Hf3ksKgQr',
  'Other Properties - Address 2 HOA': 'pVzy74Q0ioZONlubkAeF',
  'Other Properties - 2 Taxes - Monthly': '1b1X8DrLnAMoXajAhqzW',
  'Other Properties - 2 Insurance - Monthly': 'cBtaxLQUD6MpCsJ6oD6o',
  'Other Properties - 2 HOA Amount': 'ZKQwl11m5oGCz2hmzmeY',
  'Other Properties - Address 3': 'PZMBtF1mSwb5YdhzqNqi',
  'Other Properties - Address 3 Escrowed': 'cvbes8OoBauXgaa9HvCK',
  'Other Properties - Address 3 HOA': 'pq6NttoZby18ZhjCPQY4',
  'Other Properties - 3 Taxes - Monthly': 'hofZYNxfNqXX8aULPmV3',
  'Other Properties - 3 Insurance - Monthly': '93FKe5g1JkURYAJP73Qz',
  'Other Properties - 3 HOA Amount': 'cRQOETyKpRlCIej5cJ6B',
...
const FORM_NAME_ALIASES: Record<string, string> = {
  ...
  // Stage 1 fields → GHL field names
