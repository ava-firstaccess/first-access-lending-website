...
export type InvestorPriceLadderRow = { targetPrice: number; cappedTargetPrice: number; rate: number; noteRate: number; purchasePrice: number; pointsLabel: 'Discount' | 'Rebate'; pointsValue: number; highlighted: boolean; };
