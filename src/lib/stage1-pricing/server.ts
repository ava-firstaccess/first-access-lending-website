...
function getLadderMaxBuyPrice(engine: Stage1ExecutionQuote['engine'], maxPrice: number) {
  if (engine === 'NewRez') return 107;
  return maxPrice > 0 ? Math.ceil(maxPrice) : 0;
}
