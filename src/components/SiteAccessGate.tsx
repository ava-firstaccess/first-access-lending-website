...
export function SiteAccessGate() {
  ...
  async function submit() {
    ...
    try {
      ...
      setError('Unable to unlock site.');
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-bold text-slate-900">Site Access</h1>
        <p className="mt-2 text-sm text-slate-600">This host is private. Enter the shared password to continue.</p>
